  ...
  return (
    <div className="custom-container">
      <div className="relative flex justify-center  lg:justify-between items-center ">
        <div className="z-10 text-center  lg:text-left lg:ml-0 lg:mr-auto absolute text-3xl lg:text-5xl font-extrabold ">
          <div>
            The Best place to <br /> find your favorite <br /> Action Figures
          </div>
          <button className=" mt-4  md:px-7 py-4 btn-color font-extrabold md:text-lg rounded-lg  lg:flex ">
            Collections
          </button>
        </div>
